...
def extract_library_calls(py_file_path, ML_libraries):
...
def main():
    ...
    to_measure_over_DA = ML_components.face_recognition_Data_Aquisition
    to_measure_over_TP = ML_components.face_recognition_Training_Pipeline
    to_measure_over_ML = ML_components.face_recognition_ML_interfacing
    to_measure_over_NON = ML_components.face_recognition_Non_ML
    folder_path = ["github/face_recognition-master"]
    ...
    for project in folder_path:
        ...
        non_python_files = list_non_python_files(project)
        cohesion_list_DA = []
        cohesion_list_TP = []
        cohesion_list_ML = []
        cohesion_list_NON = []
        ...
        for file in python_files:
            ...
            method_files_dict = get_non_python_file_calls_in_method(file, non_python_files)
            methods_libraries_dict = extract_library_calls(file, ML_libraries)
            methods_parameters_dict = add_other_connections(instance_variables,method_files_dict,methods_libraries_dict)
            graph = build_graph(methods_parameters_dict)
